...
pins_channel = 902593771814928434

# TODO
# add any black listed channel IDs as a list separated by a comma (,)
# a good idea is to add admin channels to this
blacklisted_channels = [807664371391004712, 807664506900971591, 808105302368714822, 808105407212945409, 823719191773184030, 931961766953484429, 834215472509091900, 834176690045059112, 794009699397009470, 794001046514434051, 829496158136958976, 833026647967268894, 876961077664030800, 807696019641991188, 817851055111012463, 809516506815004672, 817851202456518689, 794001518806040598, 931925052528664627, 891458299936006166, 934482565891514418]
